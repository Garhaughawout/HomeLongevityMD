...
export const pageReference: ReadonlyArray<InternalDocEntry> = [
	...
	},
	{
		...
		access: "authenticated",
		purpose:
			"Multi-step intake wizard using open-license instruments per the Anchor Index v2 methodology: HSSAT home safety checklist, ADLs & IADLs (Katz/Lawton), TUG, FRAIL scale, SLUMS cognitive screen, OT clinical judgment, triggered Tier 2 pathways, and Physician Review.",
