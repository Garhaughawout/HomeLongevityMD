...
export function IntakeWizard({ client, intake }: Props) {
  ...
  function getSectionEntry(): SectionEntry | null {
    switch (currentStep) {
      case 0: return { key: "home_safety", data: homeSafety };
      case 1: return { key: "mobility", data: mobility };
      case 2: return { key: "adls_iadls", data: adlsIadls };
      case 3: return { key: "cognition", data: cognition };
      case 4: return { key: "fall_risk", data: fallRisk };
      case 5: return { key: "caregiver_support", data: caregiver };
      case 6: return { key: "physician_review", data: physicianReview };
      default: return null;
    }
  }
    ...
    return (
      <div className="flex flex-col items-center gap-4 py-16 text-center">
        ...
        <div className="space-y-1">
          <h3 className="font-semibold text-[color:var(--foreground)]">Intake Submitted</h3>
          <p className="text-sm text-[color:var(--muted)]">
            This intake record is now locked. The scoring engine will process it in Phase 10.
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="flex gap-8">
      ...
      <div className="min-w-0 flex-1">
        ...
        {/* Section form */}
        <div className="mb-8">
          {currentStep === 0 && <SectionHomeSafety value={homeSafety} onChange={setHomeSafety} />}
          {currentStep === 1 && <SectionMobility value={mobility} onChange={setMobility} />}
          {currentStep === 2 && <SectionAdlsIadls value={adlsIadls} onChange={setAdlsIadls} />}
          {currentStep === 3 && <SectionCognition value={cognition} onChange={setCognition} />}
          {currentStep === 4 && <SectionFallRisk value={fallRisk} onChange={setFallRisk} />}
          {currentStep === 5 && <SectionCaregiverSupport value={caregiver} onChange={setCaregiver} />}
          {currentStep === 6 && <SectionPhysicianReview value={physicianReview} onChange={setPhysicianReview} />}
